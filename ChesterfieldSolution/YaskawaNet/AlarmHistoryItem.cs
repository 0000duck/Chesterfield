...
{
    public class AlarmHistoryItem : IComparable
    {
        public short Code = -1;
        ...
        public AlarmHistoryItem(short _AlarmNo, short _AlarmSubNo, string _AlarmMsg)
        {
            Code = _AlarmNo;
            Subcode = _AlarmSubNo;
        ...
        public AlarmHistoryItem(string AlarmHistoryItemString)
        {
